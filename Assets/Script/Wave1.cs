...
public class Wave1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        damage = this.gameObject.GetComponentInParent<WaveManager>().wav1Damage;
        fireRate = this.gameObject.GetComponentInParent<WaveManager>().wav1FireRate;
        speed = this.gameObject.GetComponentInParent<WaveManager>().wav1Speed;
        maxHealth = this.gameObject.GetComponentInParent<WaveManager>().wav1Health;
        CallCoroutine();
    }
    ...
    void Update()
    {
        if(ene1 == null && ene2 == null && waveInitiated && !waveComplete)
        {
            waveComplete = true;
